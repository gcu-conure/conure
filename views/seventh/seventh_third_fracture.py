...
def display_page7_3():
    ...
    with col2:
        st.markdown('<h1 class="center-text">두개골 골절</h1>', unsafe_allow_html=True)
    ...
    with col2:
        st.markdown('<div class="center-text">두개골에 골절이 예상되는 부위를 선택해주세요.</div>', unsafe_allow_html=True)
    symptom_options = [
        "이마뼈",
        "마루뼈",
        "뒤통수뼈",
    ...
    if submit:
        ...
        #     model="gpt-4",
        # )
        st.write(f"증상 부위: 두개골-{selected_symptom}")
