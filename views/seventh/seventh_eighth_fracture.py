...
def display_page7_8():
    ...
    with open("assets/arm.png", "rb") as f:
        img_bytes = f.read()
    ...
    with col2:
        st.markdown('<div class="center-text">팔에 골절이 예상되는 부위를 선택해주세요.</div>', unsafe_allow_html=True)
    symptom_options = [
        "위팔뼈",
        "팔꿈치 관절",
        "노뼈",
    ...
    if submit:
        ...
        #     model="gpt-4",
        # )
        st.write(f"증상 부위: 팔뼈-{selected_symptom}")
